...
Implements §7.9 (eq:dt_per_term) of the paper.

Active constraints depend on viscous treatment (§7.9 stability warnbox):

    Convective CFL:  Δt ≤ CFL · h / |u|_max           (always active)
    Capillary CFL:   Δt ≤ sqrt((ρ_l+ρ_g) h³ / (2π σ)) (§7.9 eq:dt_sigma)
...
class CFLCalculator:
    ...
    def __init__(
        ...
        # Pre-compute capillary wave time-step bound (§7.9 eq:dt_sigma):
