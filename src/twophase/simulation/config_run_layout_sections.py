...
def parse_numerics_layout(numerics: dict) -> dict:
    ...
    if "interface" in numerics and "momentum" in numerics and "projection" in numerics:
        ...
        return {
            ...
            "paths": {
                ...
                "gravity_formulation": "numerics.momentum.terms.gravity.formulation",
                "gravity_transport_adjoint": "numerics.momentum.terms.gravity.transport_adjoint",
                "gravity_metric": "numerics.momentum.terms.gravity.metric",
                "gravity_hodge_gate": "numerics.momentum.terms.gravity.hodge_gate",
                "gravity_work_gate": "numerics.momentum.terms.gravity.work_gate",
    ...
    return {
        ...
        "paths": {
            ...
            "gravity_formulation": "numerics.physical_time.momentum.gravity.formulation",
            "gravity_transport_adjoint": "numerics.physical_time.momentum.gravity.transport_adjoint",
            "gravity_metric": "numerics.physical_time.momentum.gravity.metric",
            "gravity_hodge_gate": "numerics.physical_time.momentum.gravity.hodge_gate",
            "gravity_work_gate": "numerics.physical_time.momentum.gravity.work_gate",
