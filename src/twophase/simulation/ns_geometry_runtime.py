...
def build_ns_geometry_runtime(options) -> NSGeometryRuntimeState:
    ...
    grid = Grid(
        GridConfig(
            ...
            wall_refinement_axes=options.wall_refinement_axes,
            wall_alpha_grid=options.wall_alpha_grid,
            wall_eps_g_factor=options.wall_eps_g_factor,
            wall_eps_g_factor_axes=options.wall_eps_g_factor_axes,
            wall_eps_g_cells=options.wall_eps_g_cells,
            wall_sides=options.wall_sides,
