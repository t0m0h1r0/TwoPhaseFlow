# C/RC (CCD-enhanced Rhie-Chow): CCD p'' による追加コストゼロの O(h⁴) 化
...
## 3. アプローチ B（推奨）: C/RC — CCD d2 による係数相殺
...
| 32 | herm | BLOWUP | — | NG |
| 32 | **C/RC** | **2.49e-2** | **0.42%** | OK |
| 64 | std | 5.49e-4 | 1.23% | OK |
| 64 | rich | 4.29e-4 | 1.23% | OK |
| 64 | herm | BLOWUP | — | NG |
| 64 | **C/RC** | **4.24e-4** | 1.23% | OK |
