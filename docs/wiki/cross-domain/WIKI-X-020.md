# WIKI-X-020: N-Scaling of the H-01 Mixed-Metric Residual — 128² Parasitic Blow-up (CHK-173)
...
WIKI-X-020 **extends**, does not replace, the [WIKI-X-018](WIKI-X-018.md) remediation map:
...
- Downstream cross-domain: [WIKI-X-021](WIKI-X-021.md) (N-robust full-stack architecture — 10-method role map that uses the CHK-173 evidence as its motivating constraint)
