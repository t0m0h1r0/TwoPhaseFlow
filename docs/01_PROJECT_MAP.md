...
| `11_verification.tex` + `11b_force_balance.tex` + `11c_conservation.tex` + `11d_time_accuracy.tex` + `11e_coupling.tex` + `11f_interface_crossing.tex` + `11g_error_budget.tex` | §11 | NS physical consistency: force balance, conservation, time/space accuracy, coupling, error budget |
