...
| branch | worktree-h01-remediation-theory |
| last_CHK | CHK-154 DONE 2026-04-20 — H-01 remediation 理論補完: SP-A §6.3 三 caveat 解決 ([WIKI-T-050](wiki/theory/WIKI-T-050.md) 非一様 μ/λ/ν, [WIKI-T-051](wiki/theory/WIKI-T-051.md) face-locus wall BC, caveat 3 は spsolve 直接解法のため非該当を [WIKI-T-046](wiki/theory/WIKI-T-046.md) に追記) + 即時最小修正 R-1.5 提案 ([WIKI-T-052](wiki/theory/WIKI-T-052.md) + [WIKI-L-023](wiki/code/WIKI-L-023.md), 3 行編集 / `_fvm_pressure_grad` を ψ 流用 / const κ で BF=機械精度) + [WIKI-X-018](wiki/cross-domain/WIKI-X-018.md) に R-1.5 行追加 + PoC ゲート再構築 (R-1.5 と R-1 を並行化). 新規 wiki 4件, INDEX 155→159. コード変更ゼロ. Branch: worktree-h01-remediation-theory |
| next_action | [NEXT] CHK-155: 別ワークツリーで R-1.5 Phase 1 実装 ([WIKI-L-023](wiki/code/WIKI-L-023.md)) → ch13_02_waterair_bubble.yaml 検証 (T=20 まで暴走なし, bf_residual_max < 1e-8). 並行して FCCD R-1 PoC-1/2/3 ([WIKI-T-046](wiki/theory/WIKI-T-046.md)) を企画. |
...
- Wiki: **159 entries** (docs/wiki/INDEX.md). T-050/T-051/T-052 + L-023 added 2026-04-20 (CHK-154).
