...
| next_action | worktree-exp11_21-gpu-perf MERGED to main 2026-04-12 with CHK-122 (cn_diffusion_axis perf, 1 commit on top of CHK-121); worktree-meta-deploy-claude MERGED to main 2026-04-12 with CHK-123 (EnvMetaBootstrapper redeploy, 1 commit on top of main); worktree-asm-122a-drift ready-to-merge with CHK-124 (ASM-122-A diagnosis, 1 commit on top of CHK-123). Awaiting user authorization to push to origin/main. Remaining ch11 GPU opt-in candidates: exp11_14_picard_dc, exp11_25_cn_viscous_temporal (both need hybrid scipy.sparse layout), exp11_22_zalesak_nonuniform (no committed baseline), exp11_24_dgr_verification, exp11_27_pressure_filter_prohibition, exp11_12b_split_ppe_ccd / exp11_15_ab2_time / exp11_28..29. Or jump to ch12. Other open items: FieldExtender upwind nan (CPU+GPU); ASM-122-A now CLOSED-FUNDAMENTAL. Operational: parallel-worktree rsync race partially mitigated by --checksum in remote.sh (95b00c5); fundamental per-worktree REMOTE_DIR fix still deferred. CHK ID-collision incidents now total 3 (CHK-115×2, CHK-122×1) — consider per-worktree CHK-prefix or registry. |
