...
| next_action | Awaiting user confirmation; optional: run end-to-end GPU benchmark on RTX 3080 Ti box (exp13_02) once hardware is available; remaining follow-ups scoped out of this pass (RawKernel fusion, PCR Thomas, ScalarField.version counter for outer-step PPE cache hits). |
