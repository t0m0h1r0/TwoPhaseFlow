...
- **Baseline:** CHK-123 (2026-04-12, v5.2). Bootstrap input list: 9 files in `prompts/meta/` (`_hybrid-template.md` was absorbed into `meta-deploy.md` at v1.1, see CHK-v1.1).
