...
# Generated by EnvMetaBootstrapper | Target: Claude | Date: 2026-04-12
...
| AP-09 | Context Collapse | HIGH | ALL (v5.2) |
| AP-10 | Recency Bias | MEDIUM | 5 classifiers (v5.2) |
...
Full text: `prompts/meta/meta-core.md §DESIGN PHILOSOPHY`.
...
- **Baseline:** CHK-122 (2026-04-12, v5.2). Bootstrap input list: 9 files in `prompts/meta/` (`_hybrid-template.md` was absorbed into `meta-deploy.md` at v1.1, see CHK-v1.1).
