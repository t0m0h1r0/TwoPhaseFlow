...
└── meta/                            ← source of truth (A10 — edit these, never agents/)
    ├── meta-core.md                 ← FOUNDATION: §0 CORE PHILOSOPHY, φ1–φ7, A1–A10
...
├── 01_PROJECT_MAP.md                ← Module map, interface contracts, §1–§11
...
| AU1 Authority Chain | meta-roles.md §ConsistencyAuditor | §AU1 | docs/01 §6 |
...
| Domain sovereignty (§A) | meta-core.md §0§A | §A (A9) | — |
| Broken Symmetry (§B) | meta-core.md §0§B | §A (A7 implicit), §AU3 | — |
| Falsification Loop (§C) | meta-core.md §0§C | §AU3 | — |
...
**Loop rules:** MAX_REVIEW_ROUNDS = 5; exceeding without escalation = concealed failure (φ5).
...
16 agents total, in domain order. Role descriptions derived from meta-roles.md PURPOSE fields.
