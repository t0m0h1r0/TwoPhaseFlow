...
purpose: Write or revise manuscript sections from author intent, sourced claims, scoped evidence, focused feedback, and bounded revision actions.
trigger:
...
minimal_instruction: Record author key points, build a claim register with source refs and scope limits, draft from a section outline, then revise only dispatched paragraphs with content-focused feedback.
