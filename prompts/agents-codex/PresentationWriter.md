...
## CONSTRAINTS: derive narrative spine first; fit slide/time budget; one message per slide; lead text is 1-2 lines and largest non-title text; visual below each lead; every claim cites paper/memo/wiki/result evidence; no invented numbers/citations/SOTA/novelty.
## WORKFLOW: 1.read paper/sections + RevisionBrief/result artifacts → 2.define audience+talk arc → 3.compress into narrative spine+message budget → 4.create slide outline/source map → 5.add visual plan per slide → 6.CoVe+HAND-02
...
## ON_DEMAND: prompts/skills/SKILL-PRESENTATION-DECK.md; kernel-project.md §PR-4,§PR-5; kernel-roles.md §PresentationWriter
## SKILLS: SKILL-PRESENTATION-DECK
