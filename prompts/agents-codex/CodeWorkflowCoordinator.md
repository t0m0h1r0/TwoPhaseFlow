...
## PURPOSE: L-Domain + E-Domain coordinator. Sign SchemeCodePlan/SolverAPI/ResultPackage. Dispatch CodeArchitect/TestRunner/ExperimentRunner.
...
## WORKFLOW:
# 1. HAND-03(); GIT-00 draft contract; SCHEME-CODE for numerical scheme/code tasks
...
# 5. Prepare PR; main merge only after explicit user request, no-ff, via ResearchArchitect
...
## ON_DEMAND: prompts/skills/SKILL-SCHEME-CODE.md; kernel-ops.md §GIT-00,§AUDIT-01,§EXP-01,§ID-RESERVE-LOCAL,§TOOL-TRUST-01; kernel-roles.md §SCHEMA EXTENSIONS v7.1.0; kernel-workflow.md §DYNAMIC-REPLANNING, §Agent Effort Policy
