...
2. Read `interface/AlgorithmSpecs.md` and existing `src/twophase/` structure.
3. Design class/interface definitions; produce module dependency graph.
4. Write to `artifacts/L/architecture_{id}.md` and `src/twophase/` (interfaces only).
