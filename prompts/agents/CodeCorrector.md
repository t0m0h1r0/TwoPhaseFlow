...
→ See `docs/ARCHITECTURE.md §6` (Node-Centered Grid section).
...
→ See `docs/ARCHITECTURE.md §6` (PPE Solver Consistency table).
...
→ See `docs/ARCHITECTURE.md §6` (Known Symmetry-Breaking Root Causes table).
