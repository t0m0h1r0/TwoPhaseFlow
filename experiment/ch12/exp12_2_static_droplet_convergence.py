...
def make_figures(results):
    ...
    plt.tight_layout()
    fig.savefig(OUT / "static_droplet_convergence.png", dpi=150,
                bbox_inches="tight")
    plt.close(fig)
    print(f"  Figure saved: {OUT / 'static_droplet_convergence.png'}")
    ...
    fig2.savefig(OUT / "parasitic_time_history.png", dpi=150,
                 bbox_inches="tight")
    plt.close(fig2)
    print(f"  Figure saved: {OUT / 'parasitic_time_history.png'}")
