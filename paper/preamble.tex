...
% -- Fonts (following additional.tex) --
\setmainfont{Times New Roman}
% \setCJKmainfont{Hiragino Mincho ProN} % Removed to avoid xeCJK warning (handled by class option)
...
% -- Page layout --
\geometry{reset, a4paper, top=25mm, bottom=28mm, left=26mm, right=26mm, headheight=16pt, footskip=14pt}
