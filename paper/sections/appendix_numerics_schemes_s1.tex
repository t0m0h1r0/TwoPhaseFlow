...
本稿の実装では ALE 補正を省略しており（§\ref{app:grid_ale} タイトル参照），上昇気泡ベンチマーク（§\ref{sec:bench_bubble}）では時間刻み精度の確認を格子収束テストとあわせて実施することを推奨する．
