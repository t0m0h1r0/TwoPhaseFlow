...
以下の安定化戦略は条件数の緩和に有効だが，この発散問題の根本的解決には
§~\ref{sec:gfm} の GFM 分相解法が必要である．
...
\begin{itemize}
  ...
  \item \textbf{最近接点 Hermite 補間による界面越し圧力延長（§~\ref{sec:gfm}・§~\ref{sec:extension_pde}）：}
        PPE 求解前に圧力場を最近接点 Hermite 補間で界面越しに $\Ord{h^6}$ 精度で延長することで，
