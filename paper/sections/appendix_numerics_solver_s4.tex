...
付録~\ref{app:rhie_chow_full} を参照．本稿は DCCD 散逸 + Extension PDE（§\ref{sec:gfm}）により
Rhie--Chow 補正を代替する．
...
\noindent\textbf{注：本稿（CSF + Extension PDE + DCCD 定式化）では}
DCCD フィルタ（§\ref{sec:dccd_decoupling}）が PPE 右辺のチェッカーボード対策を担い，
Extension PDE（§\ref{sec:gfm}）が界面越し圧力延長を行う．
