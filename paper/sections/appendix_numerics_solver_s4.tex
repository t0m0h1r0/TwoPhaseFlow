...
付録~\ref{app:rhie_chow_full} を参照．本稿は DCCD 散逸 + 最近接点 Hermite 延長（§\ref{sec:field_extension}）により
Rhie--Chow 補正を代替する．
...
\noindent\textbf{注：本稿（CSF + 最近接点 Hermite 延長 + DCCD 定式化）では}
DCCD フィルタ（§\ref{sec:dccd_decoupling}）が PPE 右辺のチェッカーボード対策を担い，
最近接点 Hermite 補間（§\ref{sec:field_extension}）が界面越し圧力延長を行う．
