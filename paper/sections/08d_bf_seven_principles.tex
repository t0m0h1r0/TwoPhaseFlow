...
\begin{itemize}[noitemsep]
  ...
  補正後の毛管 cochain は §~\ref{sec:split_ppe_capillary_range_projection} の
  $D_f A_f G_f$ 値域へ射影してから速度補正へ渡す．
  \item \textbf{本稿の標準経路}：
  GFM/affine-jump + HFE + DC 残差契約 + range projection を用い，
  補正段階に渡る毛管 cochain を同じ face complex の値域へ閉じる．
