...
高次片側データ，変分毛管 cochain と Hodge gate，欠陥補正，大域ゲージ・再投影分離の七つに分解し，
それぞれに必要な数理構成を順に定める．
...
\begin{enumerate}[noitemsep]
  ...
  \item \textbf{毛管 cochain 閉包問題}：
        表面エネルギーの仮想仕事を pressure-adjoint face cochain として構成し，
        成分体積反力を saddle で取り除き，静的平衡成分と非平衡駆動を分離する．
...
\begin{gathered}
  ...
  +\mathrm{HFE}
  +\widehat c_{\sigma,f}\ \text{from component saddle},\\
  \mathrm{DC}\{\eta_{\mathrm{DC}}\le\varepsilon_{\mathrm{PPE}}\}
  +\text{大域ゲージ・再投影分離}
\end{gathered}
\]
である．FVM/FD，CSF，smoothed-Heaviside 一括 PPE，直接解型 CCD，
