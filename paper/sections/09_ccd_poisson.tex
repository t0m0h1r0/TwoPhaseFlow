...
%
% ═══════════════════════════════════════════════════════════════════════════════
\section{圧力 Poisson 方程式の解法：分相 PPE・HFE・変分毛管 Hodge 閉包・欠陥補正法}
\label{sec:ppe_solve}
...
高次片側データ，変分毛管面共鎖と Hodge 平衡判定，欠陥補正，大域ゲージ・再投影分離の七つに分解し，
それぞれに必要な数理構成を順に定める．
...
\begin{enumerate}[noitemsep]
  ...
  \item \textbf{毛管面共鎖閉包問題}：
        表面エネルギーの仮想仕事を圧力仕事と随伴な面共鎖として構成し，
