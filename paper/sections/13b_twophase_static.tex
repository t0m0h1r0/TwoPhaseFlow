...
したがって pressure-jump 経路では \texttt{pressure\_hodge} を圧力図の契約とし，
interface band を NaN で消す \texttt{pressure\_bulk} 型の図は採用しない．
この確認は数値軌道を変えず，「何を圧力として読むか」という出力契約だけを
検証するものである．
...
\begin{itemize}\setlength{\itemsep}{0pt}
  ...
  \item \textbf{比較参照（CCD/FD 比）}：$\rho_r=1, N=32$ で CCD は FD の $1/5.44$，
        ...
        $\rho_r \!\ge\! 100$ では range-projected pressure-jump stack
        （分相 PPE + DC + HFE + capillary range projection；U6, V6/V7）が必要．
