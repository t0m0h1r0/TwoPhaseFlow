...
\textbf{※ Level 3 の 3--10$\times$ Level 2 throughput は}
\textbf{理論見積もり（Radau IIA の $\Delta t$ 拡大比 + JFNK Krylov コスト）に基づく
設計目標であり，数値検証は未完了（§~\ref{sec:verify_level3_benchmark} にて計画中）．}
