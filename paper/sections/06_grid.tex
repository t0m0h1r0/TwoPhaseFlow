...
$\delta_\varepsilon^*$ は $[\text{長さ}]^{-1}$ の次元を持つため，$\varepsilon_g\,\delta_\varepsilon^*$ により無次元化している（$\delta_\varepsilon^*(0) = 1/(\varepsilon_g\sqrt{\pi})$ を代入すると $\varepsilon_g\,\delta_\varepsilon^*(0) = 1/\sqrt{\pi} \approx 0.564$）．
...
% §cls_on_nonuniform は §7（§~\ref{sec:cls_on_nonuniform}）に移動した．
