...
圧力反力代表 & scalar PPE の発散だけを合わせると，圧力仕事に直交しない divergence-free 代表差 $Z$ が残る &
...
このとき $G_A$ は scalar PPE のための任意の高次勾配ではなく，
式~\eqref{eq:pressure_reaction_green_identity} を満たす圧力反力代表である．
したがって $D_f\widetilde G=D_fG_A$ を満たすだけの
divergence-equivalent 代表 $\widetilde G$ は，圧力仕事と毛管 Hodge 分解の意味では
同じスキームではない．
