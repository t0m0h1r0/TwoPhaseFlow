...
$g : I \to \mathbb{R}$ は $C^2$ 級の狭義単調増加関数（$g' > 0$ on $I$）とする．
このとき $\phi \in I$ を満たす点において，
\begin{equation}
...
CLS 法の平滑化ヘヴィサイド関数
$g = H_\varepsilon$，$H_\varepsilon(\phi) = 1/(1+e^{-\phi/\varepsilon})$ は
$\phi \in \mathbb{R}$ 全域で $C^2$ かつ $H_\varepsilon' > 0$ を満たすため，
連続レベルでは定理~\ref{thm:curvature_invariance} が全域で成立する．
一方，$H_\varepsilon'(\phi) = \varepsilon^{-1}\psi(1-\psi)$ であるから，
...
\]
に限定する．これは界面近傍帯 $|\phi| \lesssim O(\varepsilon)$ に対応する．
