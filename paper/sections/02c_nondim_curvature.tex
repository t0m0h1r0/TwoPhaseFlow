...
\end{align}
ここで，右辺の $\bm{x}, \bu, t, p, \rho, \mu, \bnabla, \phi, \kappa$ は全て無次元量である．
...
\hline
\end{tabular}
\caption{無次元数の定義と力の比としての解釈．$Ca,Bo$ は独立パラメータではなく $We/Re, We/Fr^2$ から派生する。}
...
$\phi = \varepsilon\,\ln\bigl(\psi/(1-\psi)\bigr)$ のもとで
