...
構成 & 検出する違反 & 期待される判定 \\
\hline
非整合な節点勾配 + 事後面平均 & 面評価位置不一致，補正 $G_h$ 不一致 & FAIL \\
同一 face-adjoint pair & PPE と補正の面複体共有 & PASS \\
pressure-jump Hodge 平衡判定 & 静的平衡でない毛管 Hodge 成分の消去 & FAIL \\
\hline
\end{tabular}
\end{center}
...
標準 pressure-jump 閉包では affine-jump face law と変分毛管 Hodge 平衡判定を用い，
