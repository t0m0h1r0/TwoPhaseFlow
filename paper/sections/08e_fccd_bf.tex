...
$\Ord{\Delta x^4}$ まで下がるが，Phase 1 の GFM/CSF 経路では
...
\begin{equation}
  ...
  \qquad S = \frac{1}{\Delta t_{\mathrm{proj}}}\,D_h^\text{bf}\,\mathbf{u}^*,
...
\end{equation}
これは $\mathbf{u}^*=\mathbf{0}$ から開始し，重力加速度と
