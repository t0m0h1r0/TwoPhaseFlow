...
\end{equation}
と書く．ここで $\mathcal{A}_h$ は境界チャートのアトラスであり，
成分ごとにグラフチャート，閉曲線チャート，開曲線チャート，
または局所切断セルチャートを持ってよい．
毛管波は $\Omega_g=\{y>\eta(x)\}$ のグラフチャート，
閉じた振動液滴は閉曲線の内側または外側を所有する閉曲線チャート，
上昇気泡と上部気相層は複数成分
