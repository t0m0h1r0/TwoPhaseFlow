...
近似計算を使う場合，近似誤差は毛管加速度の仕事ノルムで明示する．
...
\end{equation}
である．GPU 実装では，アクティブ面テーブル，Schur/PCG ベクトル，
component-volume Hodge probe をデバイス上に保持し，
この誤差境界と flat/static zero-drive，wave nonzero-drive の両ゲートを
満たした場合にのみ AO-Fast 経路を受理する．
