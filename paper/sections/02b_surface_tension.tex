...
\subsubsection{圧力反力部分空間と AO-Fast 毛管分解}
\label{sec:capillary_pressure_reaction_subspace}
AO-Fast 幾何毛管分解で高速化する対象は，曲率値そのものではなく，
表面エネルギー仮想仕事の面速度空間上の Riesz 代表である．
...
\end{equation}
と表す．圧力で吸収できる反力は，全ての cell-pressure 勾配像ではなく，
...
固定アクティブ集合上で capillary Riesz 代表と full cell-pressure reaction を
同じ Schur 系
\begin{equation}
...
これは非零の節点残差が存在しても，full cell-pressure image への過射影では
面上の毛管仕事を全て圧力反力として消してしまうことを意味する．
したがって AO-Fast の正しい高速化単位は，
...
ここでは近似反復法や GPU 実装の受理則を論じない．
AO-Fast がこの理論境界を高速に満たすための幾何セル分率状態空間，
アクティブ集合，近似誤差境界，PCG/DC の扱い，YAML/fail-close 契約は，
第~\ref{sec:ao_fast_state_space}節で数値アルゴリズムとして定式化する．
