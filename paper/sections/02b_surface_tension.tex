...
分相 pressure-jump PPE が高密度比の圧力閉包を担う，というものである．
...
CSF/BF 縮約経路では V3/V5/V8 の静止液滴・寄生流れ診断で読む．
高密度比の主経路では同じ Young--Laplace 応力を
surface-energy virtual-work pressure-jump/Hodge stack
（V6/V7/V9）として別途検証する）．
...
この連続仮想仕事を同じ face-space Riesz/Hodge 問題へ写し，
pre-reinit endpoint 上の本番力，成分体積反力，静的平衡 gate を
同じ pressure-adjoint metric で区別して定式化する．
