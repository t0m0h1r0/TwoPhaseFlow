...
したがって本稿で保持する階層は，
CSF が一流体/BF 経路の縮約モデルを与え，
分相圧力ジャンプ PPE が高密度比の圧力閉包を担う，というものである．
CSF 縮約では $\Ord{\varepsilon^2} \approx \Ord{\Delta x^2}$ のモデル誤差が残るため
...
表面エネルギー仮想仕事に基づく圧力ジャンプ/Hodge 閉包
（V6/V7/V9）として別途検証する）．
...
§~\ref{sec:ccd_def} 以降の FCCD（面中心 CCD; face-centred CCD）は
...
離散アフィンジャンプでは，このジャンプを節点平均ではなく界面が通過する
