% paper/sections/appendix_g_verification_details.tex
%
% 付録 G: 検証の補足解析
%   G.1 PPE 離散化の選択（§12.5 から移動）
%   G.2 HFE の smoothed-Heaviside 圧力場への適合性（§12.4 から移動）
%   G.3 V7 IMEX-BDF2 二相時間精度の支配因子解析（§13.4 補足）
% ═══════════════════════════════════════════════════════════════════════════════
\section{検証の補足解析}
...
% ─────────────────────────────────────────────────────────────────────────────
\subsection{V7 IMEX-BDF2 二相時間精度の支配因子解析}
\label{app:v7_imex_bdf2_rca}
% ─────────────────────────────────────────────────────────────────────────────

本付録は §~\ref{sec:imex_bdf2_twophase_time} の V7 に対する支配因子解析を記録する．
結論は，最新の range-projected stack で観測される slope $1.59$ が
IMEX-BDF2 単体の係数誤りではなく，
\textbf{capillary pressure-jump / affine FCCD projection が界面帯で作る低正則性・分裂誤差}
に支配される，というものである．
したがって V7 は BDF2 単体次数の試験ではなく，
...
参照解を深くしても slope は $1.59$ 近傍に留まり，2 次には戻らない．\\
...
本文の計算経路は V7 の本文値を再現し，局在構造も物理対照と整合する．\\
