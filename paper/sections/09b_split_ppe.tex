...
raw な $\sigma\kappa_{lg}$ は保存しない．この契約は毛管波専用ではなく，
...
格子再生成後は jump face cache（crossing，$s_f$，$H_f$，$\alpha_f$，$j_f$）と
HFE 延長文脈を補間せず，現在の $\phi,\psi$ と grid geometry cache から再構築する．
