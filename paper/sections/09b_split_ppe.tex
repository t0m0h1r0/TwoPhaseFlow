...
本式~\eqref{eq:split_ppe_fccd_block} は eq:~\eqref{eq:split_ppe} の
$\nabla^2 p_q = \rho_q\,q$ と等価：
$\rho_q$ 定数のため product-rule 第 2 項
...
を満たし，両相 RHS の延長が滑らか（HFE 後）と仮定すると
...
$|\bnabla\psi|=1$（HFE 上の SDF 性）を用いれば，
