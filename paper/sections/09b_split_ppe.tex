...
分相 PPE は単一の離散化名ではなく，次の 5 つを同時に満たす圧力閉包を指す．
\[
  \text{相内定数密度 Poisson}
  \;+\;
...
\begin{itemize}[noitemsep]
  ...
  \item 水--空気級高密度比：smoothed-Heaviside 一括 PPE のみでの高精度計算は未保証
\end{itemize}
%
...
% ─────────────────────────────────────────────────────────────────────────────
\subsubsection{再メッシュ再投影における圧力ジャンプ情報の分離}
