...
Hodge 代表であり，interface-fitted band を ``未定義'' として消す
masked 表示ではない．cochain が保存されていない古い結果では，
raw 圧力や masked 圧力へ暗黙に落とさず，plot は失敗させて再生成を要求する．
これは画像出力の契約であって，PPE や速度補正式の代替計算経路ではない．
