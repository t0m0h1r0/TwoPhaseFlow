...
\begin{description}\setlength{\itemsep}{0pt}
  \item[U6-a] DC $\omega$--緩和 guard．$N=64$ 円界面 $R=0.25$，
        ...
        保証対象 primitive と見なさないための guard として stall 判定を記録する．
...
\begin{itemize}\setlength{\itemsep}{0pt}
  \item U6-a DC $\omega$--緩和 guard：$\rho_l = 1$ は base GMRES 単独で収束（DC stall 無）；
        ...
        同時に高密度比の一括 PPE を保証対象 primitive としないための guard でもある．\checkmark
...
高密度比の統合検証は，一括 PPE ではなく V6/V7 の
