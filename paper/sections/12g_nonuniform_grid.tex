...
\begin{enumerate}[noitemsep]
  ...
  \item \textbf{寄生電流と Laplace 圧の劇的改善（$N = 48$）：}
        \emph{注意：本テストでは界面適合格子側で再初期化を無効化しているため，
...
% ─────────────────────────────────────────────────────────────────────────────
\subsection{非一様格子上の CLS 移流精度}
\label{sec:nonuniform_advection}
% ─────────────────────────────────────────────────────────────────────────────

\noindent\textbf{目的：}
§~\ref{sec:nonuniform_grid_ns} の静止液滴テストでは界面は移動しなかった．
...
\subsubsection{$\xi$ 空間 $\varepsilon$ 定義の検証}
