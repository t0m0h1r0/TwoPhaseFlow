...
% ═══════════════════════════════════════════════════════════════════════════════
\subsubsection{2次元 CCD-Poisson 演算子のクロネッカー積による大域行列表現}
...
%% 旧所在: §8.2.2（08c_ccd_poisson.tex）→ 付録 C.3 へ移動（CHK-086）
...
\subsubsection{2次元 CCD-Poisson 演算子の Matrix-Free 評価手順}
\label{sec:ccd_matrix_free_eval}
%% 旧所在: §8.2.3 algbox（08c_ccd_poisson.tex）→ 付録 C.3 へ移動（CHK-086）
...
%% 旧所在: §8.4（08f_ppe_bc.tex）→ 付録 C.3 へ移動（CHK-086）
