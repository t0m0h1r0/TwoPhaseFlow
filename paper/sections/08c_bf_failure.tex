...
\end{equation}
が要請される．pressure-jump 標準経路では同じ条件を
$A_f G_f p-c_f(j_{gl})=\mathbf{0}$ という face cochain の釣合として読む．
...
\begin{description}[leftmargin=2em,style=nextline]
  ...
  \item[\textbf{F-4} 面係数 $A_f$（または $\betaf=(1/\rho)_f$）の経路不一致]
    PPE / 速度補正 / 毛管ジャンプ cochain で面係数の平均化
...
面フットプリント不一致の抑制と，
pressure-jump cochain の値域閉包を分離して示す．
