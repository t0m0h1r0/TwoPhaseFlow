...
Extension PDE（§~\ref{sec:extension_pde}）が PPE 求解前に圧力場を界面越しに滑らかに延長し，
...
\textbf{CCD + CSF + 最近接点 Hermite 延長 + DCCD}（本稿） & Gibbs 振動を除去，数値成分 $\Ord{h^6}$ & $\boldsymbol{\Ord{h^6}}$\textbf{（Hermite 補間律速）} \\
\hline
\end{tabular}
\end{center}
