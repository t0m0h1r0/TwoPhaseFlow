...
% ═══════════════════════════════════════════════════════════════════════════════
\subsubsection{U5：\texorpdfstring{$H_\varepsilon$ / $\delta_\varepsilon$}{H-epsilon / delta-epsilon} モーメント精度 [Tier III]}
...
\begin{table}[!ht]
\caption{U5-a：\texorpdfstring{$H_\varepsilon$ / $\delta_\varepsilon$}{Heps / deltaeps} モーメント誤差}
...
\begin{table}[!ht]
\caption{U5-b：スケール係数 \texorpdfstring{$c = \varepsilon / h$}{c = epsilon / h} の 0 次モーメント誤差比較}
...
\caption{U5：\texorpdfstring{$H_\varepsilon$ / $\delta_\varepsilon$}{Heps / deltaeps} モーメント精度}
\label{fig:ch12_u5}
