...
\begin{description}\setlength{\itemsep}{0pt}
  ...
  \item[Tier X（アクティブ幾何毛管分解の事前ゲート）]
        ...
        成分体積 Hodge 診断が非静的波を検出すること，および未受理の近似分解を標準物理経路へ入れない境界を確認する
...
V11 が標準物理経路へ混入させる前の統合前受理境界を確認し，第~\ref{sec:benchmarks}章の毛管波結果とは区別する． \\
...
未受理の近似分解を標準物理経路へ混入させないための境界を確認する．
...
U12 & X & アクティブ幾何毛管分解の $R_p$ ゲート：全圧力像への過射影反例，成分体積 Hodge 診断，標準経路への採用境界． & V11 の統合前ゲートへ送り，未通過の分解は第14章の本番毛管波結果とは分ける． \\
\bottomrule
\end{tabularx}
\end{table}
