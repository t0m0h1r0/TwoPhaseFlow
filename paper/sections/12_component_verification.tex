...
U12 が全圧力像への過射影反例，成分体積 Hodge 診断，標準経路への採用境界を事前ゲートとして確認する． &
V11 が移動格子面共鎖・圧力履歴座標・DC 収束判定を加えた統合受理境界を確認し，第~\ref{sec:benchmarks}章の毛管波経路へ接続する． \\
...
U12 & X & アクティブ幾何毛管分解の $R_p$ ゲート：全圧力像への過射影反例，成分体積 Hodge 診断，標準経路への採用境界． & V11 で移動格子面共鎖・圧力履歴座標・DC 収束判定を加えた最終契約へ送る． \\
\bottomrule
\end{tabularx}
\end{table}
