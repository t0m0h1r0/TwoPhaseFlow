...
V11 & アクティブ幾何毛管分解ゲート & 全圧力像への過射影を棄却し，$R_p$，移動格子面共鎖，圧力履歴座標，DC 収束判定を採用境界にする & 厳密全圧力分解は毛管波駆動 $0$；成分体積 Hodge 診断は N32/N64 $2.1176/2.3055$；最終契約は第14章毛管波経路へ接続 & \checkmark 契約 \\
\bottomrule
\end{tabularx}
\end{table}
...
\begin{enumerate}\setlength{\itemsep}{0pt}
  ...
  \item \textbf{アクティブ幾何毛管分解の圧力反力分解ゲート}．V11 は，
        ...
        第~\ref{sec:benchmarks}章の毛管波結果はこの契約を満たす経路として読む．
