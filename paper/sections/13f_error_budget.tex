...
V11 & アクティブ幾何毛管分解ゲート & 全圧力像への過射影を棄却し，$R_p$，Hodge 逆適用済み面補間，移動格子面共鎖，圧力履歴座標，DC 収束判定を採用境界にする & 厳密全圧力分解は毛管波駆動 $0$；成分体積 Hodge 診断は N32/N64 $2.1176/2.3055$；最終契約は第14章毛管波経路へ接続 & \checkmark 契約 \\
\bottomrule
\end{tabularx}
\end{table}
