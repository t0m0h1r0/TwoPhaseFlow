...
界面幅パラメータ $\varepsilon$ に起因する $\Ord{\varepsilon^2} \approx \Ord{h^2}$ のモデル誤差が残り，
...
寄生流れを CSF モデル誤差の水準まで抑制する（§~\ref{sec:ppe_discretization_choice}；統合検証は第~\ref{sec:verification}章）．
