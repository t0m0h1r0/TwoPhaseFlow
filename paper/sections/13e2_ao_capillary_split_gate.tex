...
1 周期統合走行 & 第~\ref{sec:val_capillary}節の N32 毛管波は $T_\sigma=0.046742983863\,\mathrm{s}$ まで完走し，体積ドリフト最大 $9.96\times10^{-14}$，運動エネルギー最大 $8.34\times10^{-6}$，終端振幅比 $0.792$ を得た． & \checkmark 物理ベンチへ接続 \\
