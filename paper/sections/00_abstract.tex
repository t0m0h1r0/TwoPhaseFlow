...
\multicolumn{2}{@{}l}{\footnotesize 第~\ref{sec:validation}章は標準構成を毛管波・振動液滴・気泡上昇・Rayleigh--Taylor へ適用し，未達課題も含めて整理．}\\
\end{tabular}
\end{tcolorbox}
\end{center}
\vfill
...
標準構成を用いた物理ベンチマーク第~\ref{sec:validation}章の
...
Rayleigh--Lamb 型振動液滴で残る 1 周期の鋭い界面体積保存課題，
単一気泡上昇の浮力--投影閉包，
