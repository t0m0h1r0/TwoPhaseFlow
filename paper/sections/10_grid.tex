...
保存量を保存的に写像する．
さらに，投影済み速度は節点場ではなく面共鎖として新格子へ移送し，
新しい Hodge 計量で再投影する（式~\eqref{eq:ao_face_cochain_regrid}）．
...
(iii) 式~\eqref{eq:ao_face_cochain_regrid} の投影済み面共鎖移送，
