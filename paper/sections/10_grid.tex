...
表面エネルギー仮想仕事に基づく圧力ジャンプ/HFE/面閉包上の有限時間
...
\begin{tcolorbox}[mybox, title={固定格子経路と追随格子経路}]
...
そのため追随格子を採用する場合は，$\psi$ の質量を新セル体積で補正し，速度を再投影し，
...
固定格子（モード1）は縮約検証経路，毎ステップ再生成（モード2）は
