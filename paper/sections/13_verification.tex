...
pressure-coordinate history，DC 収束判定，および支配法線方向の
正則層ガードを含める．
...
V11 & アクティブ幾何毛管分解ゲート & \autoref{tab:V11_ao_gate} & 平坦界面ゼロ駆動，毛管波の非静的診断，$q$ 所有グラフ HFE，履歴分離，正則層保持，split-pending 境界 & \checkmark ゲート \\
\bottomrule
\end{tabularx}
\end{table}
