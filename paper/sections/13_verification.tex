...
V11 は，$R_p$，$q$ 所有グラフ HFE，移動格子で保存する面量，
...
このゲートには，$q$ 所有グラフ HFE ジャンプ，移動格子で保存する面量，
...
\begin{itemize}\setlength{\itemsep}{0pt}
  \item \textbf{階層構造} — V1--V2 は単相 NS（密度比 $1$）で空間/時間収束を確立し，
        ...
        V11 はアクティブ幾何毛管分解を標準構成へ入れるための統合ゲートとして扱い，
        $q$ 所有グラフ HFE と追随格子の正則層保持を同時に確認する．
...
V11 & アクティブ幾何毛管分解ゲート & \autoref{tab:V11_ao_gate} & 平坦界面ゼロ駆動，毛管波の非静的診断，$q$ 所有グラフ HFE，履歴分離，正則層保持，未確定分解境界 & \checkmark ゲート \\
\bottomrule
\end{tabularx}
\end{table}
