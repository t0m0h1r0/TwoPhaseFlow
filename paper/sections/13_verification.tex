...
V11 は，$R_p$，PhaseRegion グラフチャートの HFE 候補，移動格子で保存する面量，
...
このゲートには，PhaseRegion グラフチャートの HFE 候補，移動格子で保存する面量，
...
\begin{itemize}\setlength{\itemsep}{0pt}
  \item \textbf{階層構造} — V1--V2 は単相 NS（密度比 $1$）で空間/時間収束を確立し，
        ...
        グラフチャート HFE 候補と追随格子の正則層保持を同時に確認する．
...
V11 & PhaseRegion 毛管経路ゲート & \autoref{tab:V11_ao_gate} & 平坦界面ゼロ駆動，毛管波の非静的診断，グラフチャート HFE 候補，履歴分離，正則層保持，未確定分解境界 & \checkmark ゲート \\
