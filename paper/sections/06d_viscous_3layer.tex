...
face/corner ロカスを持つ staggered 応力配置へ拡張する場合は，
...
非一様格子，one-sided 境界，および界面帯の normal/tangent 低次化では
...
\noindent\textbf{Phi/Psi-gated bulk Laplacian 縮約}：
...
これは staggered/corner 応力配置へ拡張する場合の規則であり，
標準のコロケート応力発散では cell-center $\mu$ と共有 $\tau_{xy,i,j}$ を用いる．
