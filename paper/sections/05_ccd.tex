...
\end{align*}
上の式から下の式を引くと，$\beta_2$ が消えて
\[
  3\beta_2 = \frac{a_2}{3} - \frac{a_2}{30} + \frac{4b_2}{3} - \frac{b_2}{5}
           = \frac{9a_2}{30} + \frac{17b_2}{15}
\]
さらに式 \eqref{eq:sys_II_1} より $a_2 = 1 + 2\beta_2 - 2b_2$ を用いて $a_2$ を消去し，$\beta_2$ と $b_2$ の2元連立方程式にする．
Equation-I の場合と同じ手順で解くと，次の値が一意に定まる：
これらを解くことで，以下の係数を得る．
