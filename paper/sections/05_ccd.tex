...
Equation-I と同じ構造（3本の線形方程式，3つの未知数）であることがわかる．
式 \eqref{eq:sys_II_3} を $12$ 倍すると $\frac{\beta_2}{1} = \frac{a_2}{30} + \frac{b_2}{5}$ となり，
式 \eqref{eq:sys_II_2} との差から $a_2$ と $b_2$ の関係を消去して解くことができる．
