...
4章のステップ5では $J_x$ を $\mathcal{O}(h^2)$ 中心差分で評価しているため，
...
物理空間の2階微分も $\mathcal{O}(h^6)$ 精度が保たれる（4章の注意ボックスも参照）．
\end{tcolorbox}
...
格子精緻化テストを行い，$N$ を倍にするたびに誤差が $1/64$ 倍（$\approx 6$ 次収束）になるかを確認する（10章参照）．
