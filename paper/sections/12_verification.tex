...
単相 NS ソルバは設計精度を完全に達成する一方，
二相流では smoothed Heaviside 一括解法が密度比 $\rho_l/\rho_g \geq 10$ で破綻し，
移動界面＋表面張力（$\sigma > 0$）では IPC が 2 ステップで発散する．
これらの限界は §~\ref{sec:interface_crossing} で定量化し，
...
\midrule
静水圧バランス & $p = \rho g z$，$\bu = \bm{0}$ & $\|\bu\|_\infty$ & $< 10^{-12}$ & §\ref{sec:force_balance}\\
