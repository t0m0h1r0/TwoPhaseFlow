...
\begin{enumerate}
  \item \textbf{大域ゲージ（ジャンプ補正付き面勾配の基準拘束）：}
        ジャンプ補正付き面勾配の線形部は界面 face を通じて連結しており，
        圧力の零モードは全体定数 1 個である．
        したがって固定した大域基準値だけを与え，
