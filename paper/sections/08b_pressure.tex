...
% ─────────────────────────────────────────────────────────────────────────────
% 圧力場へのフィルタ適用禁止（詳細は §8.5 08c_pressure_filter.tex）
% 旧 inline warnbox は CHK-193 Phase D-3 で §8c 完全版と重複のため退避:
...
§~\ref{sec:dccd_pressure_filter_prohibition}（SP-J §4 \cite{SPJ}）に委ねる．
