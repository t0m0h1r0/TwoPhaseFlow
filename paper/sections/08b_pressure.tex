...
\begin{equation}
  ...
  \label{eq:predictor}
\end{equation}
$\bu^*$ は一般に発散ゼロではない（$\bnabla\cdot\bu^* \neq 0$）．
...
\subsubsection{第 3 段階：発散ゼロ条件から PPE を導く}
...
さらに，欠陥補正で得た圧力増分は，式~\eqref{eq:PPE_varrho} の
作用中の離散残差を下げる場合にだけ射影段階へ渡してよい．
残差を増やす補正は，発散ゼロ条件の未解決誤差ではなく，
圧力反力として非物理的な面加速度を注入するためである．
