...
$\frac14T_\sigma$ & $1.1693\times10^{-2}$ & $1.5635\times10^{-5}$ & $0.0781$ & $8.17\times10^{-6}$ \\
$\frac12T_\sigma$ & $2.3370\times10^{-2}$ & $-1.8339\times10^{-4}$ & $-0.916$ & $8.19\times10^{-7}$ \\
$\frac34T_\sigma$ & $3.5057\times10^{-2}$ & $-4.0506\times10^{-5}$ & $-0.202$ & $6.93\times10^{-6}$ \\
$T_\sigma$ & $4.6743\times10^{-2}$ & $1.5870\times10^{-4}$ & $0.792$ & $1.15\times10^{-6}$ \\
\bottomrule
\end{tabular}
\end{table}

運動エネルギーは最大 $8.3385\times10^{-6}$，
終端 $1.1483\times10^{-6}$ で有界である．
体積ドリフトは終端 $9.6223\times10^{-14}$，
最大 $9.9611\times10^{-14}$ であり，
