...
\]
を連続体の基準時刻とする．
本節の掲載値は，旧 CLS 経路ではなく，
第~\ref{sec:ao_fast_state_space}節のアクティブ幾何毛管分解を用いた
最新の本番経路で得た 1 周期結果である．
...
で与える．
速度へ入る毛管成分は face Hodge 上の pressure-component reaction であり，
...
\begin{itemize}[noitemsep,leftmargin=2em]
  ...
  \item スキーム：$q$ の幾何掃引輸送，列体積グラフ追跡，
        bundle Young--Laplace work，pressure-component Hodge reaction，
...
N=32 の 1 周期 run は $2585$ samples で
$t=T_\sigma=0.046742983863\,\mathrm{s}$ に到達し，
pre-blowup 判定は発火しなかった．
追随格子は終端で
\[
...
これは，本経路の圧力が HFE ジャンプと face-Hodge reaction を含む
