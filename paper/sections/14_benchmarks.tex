...
\begin{itemize}[noitemsep,leftmargin=2em]
  ...
  \item P2 reduced-ALE discrete-gradient 曲率仕事，
...
毛管波では，\texttt{interface\_amplitude} が
式~\eqref{eq:flat_capillary_dispersion} で決まる初期復元向きに振動し，
圧力ジャンプが正しい復元向きに働くことを確認した．
運動エネルギーは界面変形エネルギーとの交換として増減し，
体積保存はベンチマーク全区間で許容範囲内に留まる．
圧力 snapshot は界面近傍の Hodge 代表として読み，
diffuse interface を滑らかに塗りつぶした絶対圧分布としては解釈しない．

このケースの判定は，
「平坦界面の毛管剛性が正しい向きで PPE/corrector に伝わり，
FCCD 界面輸送と IMEX--BDF2 運動量更新が長時間で有界な振動を保つ」
である．
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.32\linewidth]{figures/ch14_osc_droplet_velocity_tq1.pdf}
\includegraphics[width=0.32\linewidth]{figures/ch14_osc_droplet_velocity_tq2.pdf}
\includegraphics[width=0.32\linewidth]{figures/ch14_osc_droplet_velocity_t1.pdf}
\par\smallskip
\includegraphics[width=0.32\linewidth]{figures/ch14_osc_droplet_pressure_tq1.pdf}
\includegraphics[width=0.32\linewidth]{figures/ch14_osc_droplet_pressure_tq2.pdf}
\includegraphics[width=0.32\linewidth]{figures/ch14_osc_droplet_pressure_t1.pdf}
\caption{N=32，1 周期振動液滴の 2 次元速度場と圧力 Hodge 代表．
上段は速度場，下段は圧力代表であり，左から
$\frac14T_\mathrm{RL},\frac12T_\mathrm{RL},T_\mathrm{RL}$ 近傍を示す．
上段の色は液相重心まわりの符号付き半径方向速度 $u_r$，
黒矢印は速度ベクトルを表す．速度色軸と矢印スケール，
