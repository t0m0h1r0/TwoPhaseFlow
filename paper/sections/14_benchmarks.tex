...
\begin{itemize}[noitemsep,leftmargin=2em]
  ...
  \item スキーム：$q$ の幾何掃引輸送，列体積グラフ追跡，
        ...
        phase-separated FCCD PPE + affine-jump HFE，DC 収束判定，
        active-geometry PCG 互換射影
...
\begin{table}[!htbp]
\caption{N=32，アクティブ幾何毛管波 1 周期 run の位相別診断}
...
圧力図は絶対値ではなく
$p-\langle p\rangle$ の対称 robust 色軸で描く．
...
\caption{N=32，アクティブ幾何毛管波 1 周期 run の時系列診断．左から，符号付き mode-2 界面振幅，
運動エネルギー，体積ドリフトを示す．}
...
\caption{N=32，アクティブ幾何毛管波の \texorpdfstring{$\psi$}{psi} snapshot．左から
