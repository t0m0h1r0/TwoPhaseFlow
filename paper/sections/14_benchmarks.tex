...
$\frac14T_\sigma$ & $1.1692\times10^{-2}$ & $1.5739\times10^{-5}$ & $0.0786$ & $8.01\times10^{-6}$ \\
$\frac12T_\sigma$ & $2.3368\times10^{-2}$ & $-1.8328\times10^{-4}$ & $-0.915$ & $8.16\times10^{-7}$ \\
$\frac34T_\sigma$ & $3.5055\times10^{-2}$ & $-4.0664\times10^{-5}$ & $-0.203$ & $6.98\times10^{-6}$ \\
$T_\sigma$ & $4.6743\times10^{-2}$ & $1.5896\times10^{-4}$ & $0.794$ & $1.15\times10^{-6}$ \\
\bottomrule
\end{tabular}
\end{table}

運動エネルギーは最大 $8.3171\times10^{-6}$，
終端 $1.1466\times10^{-6}$ で有界である．
体積ドリフトは終端 $4.0251\times10^{-14}$，
最大 $4.6621\times10^{-14}$ であり，
