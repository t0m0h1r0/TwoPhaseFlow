...
\end{equation}
ここで $(1/\rho)_{i+1/2}^{\mathrm{harm}} = 2/(\rho_i + \rho_{i+1})$ は界面フェイスの調和平均密度逆数（PPE 演算子との整合性；§\ref{sec:rc_implementation} 参照）であり，符号は界面の向き（$\phi_i > 0$ か $\phi_i < 0$ か）に従い，各軸方向について独立に適用する．
