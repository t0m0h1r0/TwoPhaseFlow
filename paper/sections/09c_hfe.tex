...
% ─────────────────────────────────────────────────────────────────────────────
\subsubsection{面ジェット経由の HFE 指向状態（SP-H §4）}
\label{sec:hfe_face_jet_directional}
% ─────────────────────────────────────────────────────────────────────────────

SP-H \cite{SPH} §4 は面ジェット $\mathcal{J}_f(u)=(u_f,u'_f,u''_f)$ を
\textbf{共通再構成層}として位置付け，HFE の離散化を
節点 Hermite 補間から\textbf{面位置 Taylor--HFE} に昇格させる．
...
SP-H §3（\S\ref{sec:face_jet_def}）の現行実装は
