...
アクティブ幾何毛管分解の受理境界 & U12 & V11 で標準物理経路への混入可否を判定する．U12/V11 未通過の分解は第~\ref{sec:benchmarks}章の本番毛管波結果とは別扱いにする． \\
7 ステップ更新順序・面データ引き渡し & U1--U12 全体 & V1--V11 と表~\ref{tab:v_accuracy_summary}（更新順序，射影後面速度閉包，アフィン圧力履歴面加速度，圧力ジャンプ結合系の適用限界，アクティブ幾何毛管分解ゲート）． \\
\bottomrule
\end{tabularx}
\end{table}
