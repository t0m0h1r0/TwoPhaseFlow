...
\midrule
U12 & $R_p$ ゲートと全圧力像の過射影反例 & 平坦界面ゼロ駆動，毛管波の非静的診断，グラフ HFE，正則層保持，採用境界 & 平坦界面 $0$；N32/N64 毛管波の厳密全圧力分解は駆動 $0$，成分体積 Hodge 診断は $2.1176/2.3055$；グラフ HFE は $\|j\|_\infty=11.5323$，加重平均 $1.30\times10^{-16}$；正則層ガードは $x$ 変位 $0$ & \checkmark 診断 \\
\bottomrule
...
\begin{itemize}[noitemsep]
  ...
  \item \textbf{アクティブ幾何毛管分解ゲート：}U12 で，全圧力像への過射影は
        ...
        グラフ HFE は $\|j\|_\infty=11.5323$，$\Delta x$ 加重平均
