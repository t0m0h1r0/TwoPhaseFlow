...
または標準 pressure-jump 経路で毛管面共鎖と動的対流フラックスの評価位置を比較する場合の
...
標準 pressure-jump 経路では，この条件を毛管面共鎖と正準面補正の同一評価位置条件として読み替える．
...
面評価位置閉包を主張する箇所では Option B を用いる．
...
非零速度場では，対流フラックスも圧力・毛管 cochain と同じ面評価位置に置かれて初めて
