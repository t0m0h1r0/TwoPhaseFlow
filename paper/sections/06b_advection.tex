...
圧力/毛管閉包 & 二相標準は affine-jump PPE + 変分毛管 Hodge 閉包（§~\ref{sec:pressure}，§~\ref{sec:split_ppe_framework}）；一括 PPE は縮約・対照経路 & $\Ord{h^5}$--$\Ord{h^7}$† & Balanced--Force 面ロカスと projection-native face closure \\
\hline
\end{tabular}
\end{center}
