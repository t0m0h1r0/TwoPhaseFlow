...
$p$ / 毛管 jump & 界面で jump & Balanced--Force 面ロカス（\S\ref{sec:balanced_force}）+ affine-jump PPE / 変分毛管 Hodge 閉包（\S\ref{sec:split_ppe_framework}）\\
...
\begin{itemize}
  ...
  \item \textbf{$p$ と毛管 jump は節点勾配では閉じない．}
        ...
        surface-energy virtual work から得る pressure-adjoint Hodge 閉包で扱う．
