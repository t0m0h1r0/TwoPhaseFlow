...
\label{fig:algo_flow}
\PaperCaptionNote{概念図．界面部分系（CLS 移流・Ridge--Eikonal 再初期化・物性更新・曲率/ジャンプデータ構成，ステップ1--4）と流体力学部分系（予測・PPE・補正，ステップ5--7）が，物性値 $\rho,\,\mu$，曲率 $\kappa$，および圧力ジャンプ面データを通じて結合している．各ステップの離散方程式・実装詳細は，第~\ref{sec:algorithm}章を入り口として Part 2 の対応章で述べる．}
\end{figure}
