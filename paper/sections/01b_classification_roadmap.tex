...
\begin{enumerate}[noitemsep]
  ...
  \item \textbf{分相 pressure-jump PPE + DC + face-space 投影}：
        ...
        $D_fG_A$ と projection-native な正準面速度で閉じ，
        ...
        surface-energy/component-saddle pressure-jump stack は V6/V7/V9 で，
        一様格子・NS 非連成 CLS 強変形移流は V10-a/b で確認し，
...
projection-native face closure の組み合わせである．
...
本稿の内容は，以下の7ステップで段階的に習得することを推奨する（表~\ref{tab:chapter_overview}の章構成と対応）．
\begin{enumerate}
  \item \textbf{前提知識の確認：}
  ...
  \item \textbf{統合検証}（第~\ref{sec:verification}章）：
        U1--U9 で確立した primitive を V1--V10 の単相・二相・非一様・CLS 強変形テストへ接続し，
