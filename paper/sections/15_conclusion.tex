...
アクティブ幾何毛管分解の採用境界 & 幾何セル分率 $q_C$，互換射影，圧力反力部分空間 $R_p$，移動格子面共鎖，圧力履歴座標，近似誤差境界（§\ref{sec:ao_fast_state_space}）\\
