...
主張支持実験（V1/V2/V3/V5/V6/V8/V10-c）の headline は以下：
...
\begin{description}
  ...
  \item[V8（非一様格子 NS 静止液滴；§\ref{sec:zalesak_cls_advection} 関連）：]
  ...
  \item[V10-b/c（Zalesak / 単一渦反転）：]
        Zalesak $\alpha=2$ 体積ドリフト $0.030\%$ @ $N=128$，
        単一渦反転 $L_1 = 2.424\times 10^{-3}$ / mass drift $0.979\%$．CLS 移流の保存性を実証．
\end{description}
...
V10-a Zalesak $\alpha=1$ ドリフト 1.535\%・V10-b 重心 0.34）は，
