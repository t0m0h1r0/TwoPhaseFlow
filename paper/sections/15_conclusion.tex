...
\begin{description}
  ...
  \item[\textbf{第\ref{sec:algorithm}章：統合アルゴリズム（7 ステップ）}]
        ...
        分相 PPE + HFE + DC 経路は固定格子・現行 face-flux projection には統合済みだが，
        Mode 2 再格子化では ALE 補正と全変数リマップを追加 gate とする．
...
\begin{description}
  ...
  \item[\textbf{長時間移動界面下での分相 PPE + HFE 結合の統計解析と高密度比拡張：}]
        ...
        (iv) Mode 2 の ALE 補正，全変数保存リマップ，HFE/jump cache 再構築，
