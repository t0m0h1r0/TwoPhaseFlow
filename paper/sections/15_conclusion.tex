...
向き付き affine jump の符号検証まで完了し，振動液滴・気泡上昇・Rayleigh--Taylor は
査読時点で未完了検証ゲートとして残る．
...
\begin{description}
  ...
  \item[振動液滴（§\ref{sec:val_oscillating_droplet}）：]
        ...
        YAML は $128^2$ periodic，$\alpha=2$，
        $(a,b)=(0.275,0.225)$，$D_0=0.10$，$T=40$ とし，
        \texttt{signed\_deformation} の位相，粘性減衰包絡，
        \texttt{kinetic\_energy} の交換，体積保存を未完了の判定項目とする．
