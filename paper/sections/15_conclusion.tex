...
変密度 PPE の収束悪化 & 分相 PPE + HFE + 欠陥補正 ($k=3$)（§\ref{sec:split_ppe_recovery}，§\ref{sec:hfe}，§\ref{sec:defect_correction_ppe}）\\
...
DC k=3 補正後の分相 PPE $\Ord{h^{6.90}}$（U2 production，U6-b；§\ref{sec:defect_correction_ppe}）が
それぞれ単体で実測されている．
