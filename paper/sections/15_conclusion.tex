...
静止液滴 face-balance gate では range-projected cochain により
$\|a_f^{\mathrm{range}}\|_{\infty,f}=3.816\times10^{-17}$ を確認した
（表~\ref{tab:V3_pressure_jump_range_gate}）．
...
\begin{description}
  ...
  \item[V3（静止液滴 long-term）：]
        ...
        pressure-jump production 経路の補助 gate では
        $N=32,T=0.2$ で $\|a_f^{\mathrm{range}}\|_{\infty,f}=3.816\times10^{-17}$，
        raw Hodge residual $1.139\times10^{-3}$ を分離した．
