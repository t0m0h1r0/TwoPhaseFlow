...
P1 marching-squares による区分線形表面測度 $S_h(q_c)$ と各成分の鋭い界面体積
...
物理判断へ用いる．作用中の圧力ジャンプ経路では，
切断面 Young--Laplace 代表や表面エネルギー Riesz 代表が実効毛管面量であり，
...
節点力との差を取る従来の balanced-force residual は
作用中の毛管面量の残差ではない．
本稿の標準経路では，表面張力を
