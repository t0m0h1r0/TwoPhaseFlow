...
\textbf{左辺：}
$\frac{d}{ds}[\psi(1-\psi)] = (1-2\psi)\psi' = (1-2\psi)\cdot\frac{1}{\varepsilon}\psi(1-\psi)$

\textbf{右辺：}
$\varepsilon\frac{d^2\psi}{ds^2} = \varepsilon\frac{d}{ds}[\frac{1}{\varepsilon}\psi(1-\psi)]
= \frac{d}{ds}[\psi(1-\psi)] = (1-2\psi)\cdot\frac{1}{\varepsilon}\psi(1-\psi)$

左辺 $=$ 右辺．\textbf{すなわち $\psi = H_\varepsilon(\phi)$ は式 \eqref{eq:cls_reinit_iso} の厳密な不動点である．}\qed
