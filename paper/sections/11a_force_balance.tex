...
\begin{itemize}[noitemsep]
  ...
  \item CSF 体積力 $\bm{f}_\sigma = (\sigma/\mathit{We})\,\kappa\,\bnabla\psi / \rho$
  \item 単ステップ投影：$\bu^* = \Delta t\,\bm{f}_\sigma$ → 変密度 PPE → Corrector
...
$\Delta p$ の格子収束は $\Ord{h^{5.8}}$（CCD-PPE の $\Ord{h^6}$ 精度を反映）．
$N = 32$ では $R/h = 8$ と界面ステンシルの解像度が不足し，圧力跳びが不正確となる．
