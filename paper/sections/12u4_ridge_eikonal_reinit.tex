...
本 U4 の実体は \texttt{twophase.levelset.reinit\_eikonal\_godunov.godunov\_sweep}
（Hamilton--Jacobi 擬似時間 sweep）と
\texttt{twophase.levelset.reinit\_dgr.DGRReinitializer}（DGR 1 段補正）
...
（HJ transient で gradient overshoot；band err $\sim 0.48$）
