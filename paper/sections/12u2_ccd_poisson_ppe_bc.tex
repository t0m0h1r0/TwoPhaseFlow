...
出典：\texttt{experiment/ch12/exp\_U2\_ccd\_poisson\_ppe\_bc.py}．}
\label{fig:ch12_u2}
\end{figure}
...
\end{itemize}
A3 トレーサビリティ：§\ref{sec:defect_correction_main} の DC 反復式 →
\texttt{src/twophase/ppe/defect\_correction.py} の \texttt{PPESolverDefectCorrection}．
