...
\multirow{3}{*}{Single vortex}
 &  64 & $1.91 \times 10^{-1}$ & $8.64 \times 10^{-1}$ & $\Ord{10^{-15}}$ \\
 & 128 & $1.73 \times 10^{-1}$ & $7.99 \times 10^{-1}$ & $\Ord{10^{-15}}$ \\
 & 256 & $1.43 \times 10^{-1}$ & $7.25 \times 10^{-1}$ & $\Ord{10^{-15}}$ \\
\bottomrule
\end{tabular}
\end{table}
...
$L_\infty$ 誤差は $N = 256$ でも 0.73 と大きい（表~\ref{tab:cls_advection}）．
