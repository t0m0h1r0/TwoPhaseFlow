...
\midrule
一様              & $1.05 \times 10^{-2}$ & $3.2 \times 10^{-4}$ & $\Ord{10^{-15}}$ \\
非一様 $\alpha=2$ & $3.74 \times 10^{-2}$ & $1.5 \times 10^{-2}$ & $5.1 \times 10^{-5}$ \\
非一様 $\alpha=3$ & $3.72 \times 10^{-2}$ & $5.4 \times 10^{-2}$ & $\Ord{10^{-15}}$ \\
\bottomrule
\end{tabular}
\end{table}
...
$\alpha = 2$ では保存型再マッピングの質量補正が $5.1 \times 10^{-5}$ の残差を残すが，
...
$\varepsilon_{\mathrm{eff}}/\varepsilon \approx 1.03$ に制御された（92 倍の改善）．
