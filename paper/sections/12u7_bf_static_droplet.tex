...
出典：\texttt{experiment/ch12/exp\_U7\_bf\_static\_droplet.py}．}
\label{fig:ch12_u7}
\end{figure}
...
\texttt{src/twophase/levelset/curvature.py} と
\texttt{src/twophase/ppe/ppe\_builder.py}；
face $\mu$ 補間診断→ §\ref{sec:mu_face_interpolation} →
\texttt{experiment/ch12/exp\_U7\_bf\_static\_droplet.py} の \texttt{\_face\_interp}．
