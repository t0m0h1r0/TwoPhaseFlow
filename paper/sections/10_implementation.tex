...
$L_2$ 形状誤差は格子精緻化に伴い緩やかに減少するが，
$L_\infty$ 誤差はスロット角部・界面不連続部で $\varepsilon = \Ord{h}$ の遷移幅に律速されるため
単調減少しない場合がある（Zalesak の $L_\infty$ は $N=64\to256$ でほぼ横ばい）．
これは CLS の本質的な制約であり，同じ界面厚みで比較した場合は妥当な結果である．
