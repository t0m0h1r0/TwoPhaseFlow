...
% ═══════════════════════════════════════════════════════════════════════════════
\subsection{チェッカーボード問題の解決：Rhie--Chow 補正と DCCD 代替手法}
\label{sec:rhie_chow}
% ═══════════════════════════════════════════════════════════════════════════════
...
この操作は CLS 移流スキームに使用する Dissipative CCD（$\varepsilon_d = 0.05$，§\ref{sec:dccd_filter_design}）とは独立した，PPE 右辺専用の明示的フィルタ適用ステップである（移流の数値散逸設計とは別に，チェッカーボード除去のみを目的として適用する）．
