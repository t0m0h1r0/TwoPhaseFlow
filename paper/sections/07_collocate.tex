...
この Balanced-Force 条件を適用し，さらに HFE（§~\ref{sec:field_extension}）により
...
CSF + Balanced-Force（§~\ref{sec:csf}，§~\ref{sec:rc_balanced_force}）と HFE（§~\ref{sec:field_extension}）の組み合わせにより，
