...
この Balanced-Force 条件を適用し，さらに Extension PDE（§~\ref{sec:extension_pde}）により
界面近傍の圧力勾配精度を維持する（§~\ref{sec:dccd_decoupling} 参照）．}
...
CSF + Balanced-Force（§~\ref{sec:csf}，§~\ref{sec:rc_balanced_force}）と Extension PDE（§~\ref{sec:extension_pde}）の組み合わせにより，
