...
Phase & 内容 & 主要技術 & 適用範囲 \\
\hline
Phase 1 & 界面追跡層 & Ridge--Eikonal + FCCD 輸送 & 標準経路でも部分採用可 \\
...
\end{tabular}
\end{center}
Phase 1 の軽量版は標準経路の界面追跡層（一括 PPE 経路・分相 PPE 経路の双方）でも採用可能；
...
標準経路は，低・中密度比の比較経路として一括 smoothed-Heaviside PPE を残しつつ，
