...
発展的閉包である．
したがって本節では期待性能ではなく，検証済み primitive から
直接引き継げる契約と，本稿では未検証に留める範囲を分けて述べる．
