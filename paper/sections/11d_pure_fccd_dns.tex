...
\noindent\textbf{Phase 1--4 と Level 1/2/3 の対応：}
\begin{center}
\small
\begin{tabular}{@{}llll@{}}
\hline
Phase & 内容 & 主要技術 & Level 対応 \\
\hline
Phase 1 & 界面追跡層 & Ridge-Eikonal + FCCD 輸送 & Level 2 で部分採用可 \\
Phase 2 & 運動量移流層 & FCCD + HFE & Level 2/3 \\
Phase 3 & 粘性項分離 & 応力発散 + DC & Level 2/3 \\
Phase 4 & 分相 FCCD PPE & 分相 + GFM + DC $k{=}3$ & Level 3 完全採用 \\
\hline
\end{tabular}
\end{center}
Phase 1 の軽量版は Level 2 プロダクションでも採用可能（§\ref{sec:level2_production}）；
Phase 1--4 の同時採用は Level 3 を前提とする（§\ref{sec:level_selection}）．
...
純 FCCD は Level 2（§\ref{sec:level2_production}）と
