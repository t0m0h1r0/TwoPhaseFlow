...
圧力勾配の計算 $G_p$ に高次精度 CCD 演算子 $D^{(1)}_{\mathrm{CCD}}$ を用い，
...
\input{sections/08c_bf_failure}
\input{sections/08d_bf_seven_principles}
\input{sections/08e_fccd_bf}
