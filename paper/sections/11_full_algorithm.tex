...
質量輸送と運動量輸送を同じ界面フラックスから閉じる必要性は，
VOF の大密度比計算における Rudman~\cite{Rudman1998}，
および Level Set 法で同一フラックス密度を運動量輸送に使う
Raessi--Pitsch~\cite{RaessiPitsch2012} の結論と同じである．
