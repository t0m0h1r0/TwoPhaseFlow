...
\begin{tcolorbox}[defbox, title={11章を読むための直感}]
本章の数式は多いが，狙いは単純である．
界面を動かす量，速度を動かす量，圧力でつじつまを合わせる量が，
すべて同じ界面面データを見ていることを確認する章である．
\begin{itemize}[noitemsep]
  \item 第1--4段は「界面の地図」を作り直す段階であり，
        $\psi,\phi,\rho,\mu,\kappa_{lg}$ を同じ界面形状から読める状態にそろえる．
  \item 第5段は，圧力補正をかける前に，移流・粘性・重力だけで速度を仮に進める段階である．
  \item 第6--7段は，圧力が非圧縮性，圧力ジャンプ，表面張力の釣合いをまとめて回収し，
        その結果を次の界面輸送へ渡せる面速度として返す段階である．
\end{itemize}
したがって細かい演算子記号を読むときも，
「どの物理量を更新しているか」だけでなく，
「その更新がどの界面面データを参照しているか」を追うと，
章全体の流れを理解しやすい．
\end{tcolorbox}
