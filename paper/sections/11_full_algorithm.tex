...
\textbf{段} & 役割 & 手法 & 参照 \\
\hline
第1段 & CLS $\psi$ 移流 & TVD-RK3 + FCCD 面フラックス発散（射影後の面速度；式~\eqref{eq:projection_native_psi_transport}） & §~\ref{sec:time_level1} \\
...
第5段 & 運動量 $(u,v)$ 移流 & UCCD6 + EXT2 外挿（BF 面整合を確認する一流体対照では FCCD Option B/C） & §~\ref{sec:time_level1} \\
