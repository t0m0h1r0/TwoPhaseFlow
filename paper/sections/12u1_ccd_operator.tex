...
\midrule
slope ($N\!=\!16\!\to\!128$) & $\mathbf{4.00}$ & $\mathbf{4.00}$ & $\mathbf{7.04}$ \\
\bottomrule
\end{tabular}
\\[2pt]
{\footnotesize FCCD は $f$ 内の境界モードが MMS 上で 4 次に律速（壁スキームの $\Ord{h^4}$ 端効果）；
...
FCCD 壁 4 次律速，UCCD6 対称性スーパー 7 次．
...
\begin{itemize}\setlength{\itemsep}{0pt}
  ...
  \item U1-c FCCD：MMS 設定の境界モード支配により実効 4 次（条件付き合格 $\triangle$;
