% paper/sections/05d_dissipative_ccd.tex
%
% §5d  散逸的結合コンパクト差分（Dissipative-CCD）と界面適応フィルタ
...
なお，本稿が CLS 移流に採用する WENO5（付録~\ref{app:weno5}）は $\psi$ 場の移流安定化が目的であり，
ここで議論するバルク速度場・圧力場の高周波ノイズ抑制とは適用対象が異なる——両者は相補的である．
...
% ─────────────────────────────────────────────────────────────────────────────
\subsubsection{スイッチ関数 $S(\psi)$ の厳密導出：CLS 平衡プロファイルから}
...
% ─────────────────────────────────────────────────────────────────────────────
\subsubsection{散逸強度 $\varepsilon_{d,\max}$ のスペクトル設計}
...
% ─────────────────────────────────────────────────────────────────────────────
\subsubsection{設計の一貫性：CCD の $O(h^6)$ 精度に対する影響の定量化}
