...
すなわち方程式 $\partial_\tau\psi + \bnabla\cdot(\psi(1-\psi)\hat{\bm{n}}) = \bnabla\cdot(\varepsilon\bnabla\psi)$
...
$\partial_\tau\psi + \bnabla\cdot(\psi(1-\psi)\hat{\bm{n}}) = \bnabla\cdot(\varepsilon\bnabla\psi)$
においても，界面法線方向 $s = \hat{\bm{n}}\cdot\bm{x}$ に沿った1次元プロファイル
